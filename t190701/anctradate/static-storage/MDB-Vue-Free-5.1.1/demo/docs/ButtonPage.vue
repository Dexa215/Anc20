<template>
  <mdb-container>
    ...
    <div class="text-center mt-5">
      ...
      <mdb-btn size="lg" color="default">Default button</mdb-btn>
      ...
      <mdb-btn icon="user" icon-left color="default">Left</mdb-btn>
      <mdb-btn icon="user" icon-right color="default">Right</mdb-btn>
    </div>
  </mdb-container>
</template>
