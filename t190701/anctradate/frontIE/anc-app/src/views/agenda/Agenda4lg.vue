...
<template>
  <div class="SfBase">
    ...
    >
      ...
      >
        <!--cx-->
        <v-card class="card_main AncAgenda">
          <v-row class="AgendaTitolo display-2">
            {{ lang.t[1].lista[4].t[1].text }}
          </v-row>
          <Timeline4lg></Timeline4lg>
        </v-card>
...
import Timeline4lg from "@/views/agenda/timeline/Timeline4lg.vue";
