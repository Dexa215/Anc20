  ...
  <div class="SfBase">
    ...
    <v-row      class="r_main r_main_h_XS mx-auto" justify="start" align="start"><!--rr-->
      ...
      <v-col cols="8" class="cx_main"><!--cx-->
        ...
        <div class="r_main_hsDown_XS">spazio Down xs</div><!--rr-->
      </v-col><!--cx-->
  ...
  export default {
    ...
    data() {
      return {
        ...
        mappa1:"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1663.15881154439!2d8.905701070027497!3d45.71332899343703!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478685f126a1ea85%3A0x7c16b78535fb871a!2sVia%20Carlo%20de%20Simoni%2C%201%2C%2021049%20Tradate%20VA!5e0!3m2!1sit!2sit!4v1576285621978!5m2!1sit!2sit",
        mappa2:"https://www.google.com/maps/embed?pb=!4v1576284624812!6m8!1m7!1sXkQU4fJD85BZziGDdsNGNw!2m2!1d45.71363123189879!2d8.906257580735!3f290.300251927189!4f2.186880441983959!5f1.1924812503605782",
        img1: "/static/images/Foto/tradatecomune.jpg",
        img2: "/static/images/Foto/clock.jpg",
    ...
    methods: {
      ...
      v(link){  this.$store.dispatch("vola", link);}
    },
    created() { },
    updated() {console.log("sedeorari3md oncreate-- > start");    },
    mounted() { }
  };
</script>
...
<style media="screen" scoped>
  ...
  /*general...*/
  /*responsive...*/
  .r_main_h_XS      {height: 600px; padding-top: 100px;}
