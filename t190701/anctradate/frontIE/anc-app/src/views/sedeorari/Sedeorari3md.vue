...
<template>
  <div class="SfBase">
    ...
    <div        class="r_main_hsUp_MD">spazio Up md</div><!--rr-->
    <v-parallax class="SfParallax" src="/static/images/bg/bg8.jpg" height="850"></v-parallax>
    <v-row      class="r_main r_main_h_MD mx-auto" justify="start" align="start"><!--rr-->
      ...
      <v-col cols="8" class="cx_main"><!--cx-->
        ...
        <div class="r_main_hsDown_MD">spazio Down md</div><!--rr-->
      </v-col><!--cx-->
