...
<template>
  <div class="SfBase">
    ...
    <div        class="r_main_hsUp_LG">spazio Up lg</div><!--rr-->
    <v-parallax class="SfParallax" src="/static/images/bg/bg8.jpg" height="850"></v-parallax>
    <v-row      class="r_main r_main_h_LG mx-auto" justify="start" align="start"><!--rr-->
      ...
      <v-col cols="8" class="cx_main"><!--cx-->
        ...
        <div class="r_main_hsDown_LG">spazio Down lg</div><!--rr-->
      </v-col><!--cx-->
