<template>
  <div class="menuS">
    ...
    <links4lg v-if="currentres == 'lg'"></links4lg>
    <links5xl v-if="currentres == 'xl'"></links5xl>
  </div>
  <!-- @@@ -->
</template>
...
/*Res Menu*/
import links1xs from "@/views/links/Links1xs.vue";
import links2sm from "@/views/links/Links2sm.vue";
import links3md from "@/views/links/Links3md.vue";
import links4lg from "@/views/links/Links4lg.vue";
import links5xl from "@/views/links/Links5xl.vue";
...
.rmvrow {
  ...
  /*background-image: url("/static/images/LinksPageCarousel/dsc32.jpg");*/
