<template>
  <div class="menuS">
    ...
    <chisiamoBenemerite1xs v-if="currentres == 'xs'"></chisiamoBenemerite1xs>
    <chisiamoBenemerite2sm v-if="currentres == 'sm'"></chisiamoBenemerite2sm>
    <chisiamoBenemerite3md v-if="currentres == 'md'"></chisiamoBenemerite3md>
    <chisiamoBenemerite4lg v-if="currentres == 'lg'"></chisiamoBenemerite4lg>
    <chisiamoBenemerite5xl v-if="currentres == 'xl'"></chisiamoBenemerite5xl>
  </div>
  <!-- @@@ -->
  <!-- lista[1]>chisiamoBenemerite sc[0]>ubicazione-->
  <!-- TEXTS:  lang.t[1].lista[1].sc[0].t[0,2,3,4,5,...,N].text -->
</template>
<script>
/*Res Menu*/
import chisiamoBenemerite1xs from "@/views/chisiamo/Benemerite/ChisiamoBenemerite1xs.vue";
import chisiamoBenemerite2sm from "@/views/chisiamo/Benemerite/ChisiamoBenemerite2sm.vue";
import chisiamoBenemerite3md from "@/views/chisiamo/Benemerite/ChisiamoBenemerite3md.vue";
import chisiamoBenemerite4lg from "@/views/chisiamo/Benemerite/ChisiamoBenemerite4lg.vue";
import chisiamoBenemerite5xl from "@/views/chisiamo/Benemerite/ChisiamoBenemerite5xl.vue";
...
export default {
  ...
  components: {
    /*menu res*/
    chisiamoBenemerite1xs,
    chisiamoBenemerite2sm,
    chisiamoBenemerite3md,
    chisiamoBenemerite4lg,
    chisiamoBenemerite5xl
  },
  props: {},
  data: () => ({}),
  computed: {
