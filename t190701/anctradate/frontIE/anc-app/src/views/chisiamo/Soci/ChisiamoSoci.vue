<template>
  <div class="menuS">
    ...
    <chisiamoSoci1xs v-if="currentres == 'xs'"></chisiamoSoci1xs>
    <chisiamoSoci2sm v-if="currentres == 'sm'"></chisiamoSoci2sm>
    <chisiamoSoci3md v-if="currentres == 'md'"></chisiamoSoci3md>
    <chisiamoSoci4lg v-if="currentres == 'lg'"></chisiamoSoci4lg>
    <chisiamoSoci5xl v-if="currentres == 'xl'"></chisiamoSoci5xl>
  </div>
  <!-- @@@ -->
  <!-- lista[1]>chisiamoSoci sc[0]>ubicazione-->
  <!-- TEXTS:  lang.t[1].lista[1].sc[0].t[0,2,3,4,5,...,N].text -->
</template>
<script>
/*Res Menu*/
import chisiamoSoci1xs from "@/views/chisiamo/Soci/ChisiamoSoci1xs.vue";
import chisiamoSoci2sm from "@/views/chisiamo/Soci/ChisiamoSoci2sm.vue";
import chisiamoSoci3md from "@/views/chisiamo/Soci/ChisiamoSoci3md.vue";
import chisiamoSoci4lg from "@/views/chisiamo/Soci/ChisiamoSoci4lg.vue";
import chisiamoSoci5xl from "@/views/chisiamo/Soci/ChisiamoSoci5xl.vue";
