...
<!-- **** -->
        ...
        <v-row dense class="row ma-2 pa-2"> <!-- row 00 --><!-- Riassunto Sede -->  
              <v-col cols="12">
              </v-col>
        </v-row>                            <!-- row 00 --><!-- Riassunto Sede -->  


        <v-row dense class="row ma-2 pa-2"> <!-- row 01 --><!-- x -->  
          <v-col cols="3" ><!--column 1-->

                      <h2 class="display-1 font-weight-bold AncTitleColorDark" 
                      > Anni
                      </h2>
