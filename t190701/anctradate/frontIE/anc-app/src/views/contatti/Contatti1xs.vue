  ...
  <div class="SfBase">
    ...
    <v-row class="r_main r_main_h_XS mx-auto" justify="start" align="start"
      ...
      <v-col cols="10" class="cx_main"
        ...
        <div class="r_main_hsDown_XS">spazio Down md</div>
        <!--rr--> </v-col
      ><!--cx-->
...
import P1small from "@/components/AncRow/Picture/p1small.vue";
...
export default {
  ...
  created() {},
  updated() {
    console.log("sedeorari3md oncreate-- > start");
  },
  mounted() {}
};
</script>
