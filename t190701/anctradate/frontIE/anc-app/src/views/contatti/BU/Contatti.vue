<template>
  <div class="contatti">
    ...
    <!-- Ai  -->
    <AncIntestazione :C="30" :CS="0" :categorie="categorie" @gotoR="gotoR"></AncIntestazione>
    <!-- Ai  -->
    ...
    <div>
      ...
      <div class="my-4 pb-2 container-fluid text-center">
          ...
          <v-col cols="6">
            <v-card class="mx-auto" max-width="400" hover>
              <v-img
                ...
                height="300px"
                src="../../src/assets/images/Soci/dscf5555-436x569.jpg"
              >
                <v-card-title>Massimo Scariot</v-card-title>
              </v-img>

              <v-card-subtitle class="pb-2 mu-4">Presidente</v-card-subtitle>
              <v-card-text class="text--primary">
                <div>
                  <h2>Massimo Scariot</h2>
                </div>
              </v-card-text>
              <v-card-actions>
          ...
          <v-col cols="6">
            <v-card class="mx-auto" max-width="400" hover>
              <v-img
                class="white--text align-end mb-4"
                height="300px"
                src="../../src/assets/images/Soci/dscf5450-436x571.jpg"
              >
                <v-card-title>Maurizio Giuliacci</v-card-title>
              </v-img>

              <v-card-subtitle class="pb-2 mu-4">Vice-presidente</v-card-subtitle>
              <v-card-text class="text--primary">
                <div>
                  <h2>Maurizio Giuliacci</h2>
                </div>
              </v-card-text>
              <v-card-actions>
                <v-btn color="orange" text>
        ...
        <v-row dense class="row ma-2 pa-2">
          ...
          <!--
              <HelloWorld msg="ANC Tradate | contatti" />
          -->
        </v-row>
        <!-- row 01 -->
        <!-- Descrizione Ubicazione -->
...
*/
  ...
  created() {
    //this.getRequestUser();
    console.log("contatti oncreate --> start");
    //this.setMyPar();
