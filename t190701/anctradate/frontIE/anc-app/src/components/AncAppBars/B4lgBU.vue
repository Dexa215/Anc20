  ...
  >
    ...
    <v-row class="r">
      ...
      <v-col :class="rcS">
        ...
        <v-row class="iconavR mx-auto my-auto" justify="center" align="center">
          <!-- ICONE NAVIGAZIONE - SX class="avatar" -->
          <v-col class="icoSx iconavcSbassa" cols="10">
            <v-row class="rIco my-auto" justify="start" align="center">
              <transition
          ...
          <v-col class="icoSx iconavcSbtnCategoriaCorrente" cols="2">
            <v-row class="rIco my-auto" justify="center" align="center">
              <!-- categoria corrente -->
              <transition
                name="custom-classes-transition"
                enter-active-class="animated bounceInLeft"
      ...
      <v-col class="rcC rcX rcC_BC" cols="4">
        ...
        <v-row class="rcCr" align="center" justify="center" style="z-index: 2">
          <v-col class="rcCrcS rcCrcX rcCrcLat_BC" cols="4">
            <v-row class="rIco" align="center" justify="end"
              ><div>ANC</div></v-row
            >
          </v-col>

          <v-col class="rcCrcC rcCrcX rcCrcC_BC" cols="3">
          ...
          <v-col class="rcCrcD rcCrcX rcCrcLat_BC" cols="4">
            <v-row class="rIco" align="center" justify="start"
              ><div>TRADATE</div></v-row
            >
          </v-col>
        </v-row>
        ...
        <v-row class="iconavR mx-auto my-auto" justify="center" align="center">
          ...
          <v-col class="icoSx iconavcS" cols="6">
            <!--
              ...
              -->
            <v-row class="rIco my-auto" align="center">
              <!-- search... -->
              <v-expand-x-transition>
                <v-btn
                  class="mx-1"
          ...
          <v-col v-if="!languagesShow" class="icoSx iconavcDD" cols="3">
            <v-row class="rIco my-auto" justify="end" align="center">
              <!-- BUTTON MENU on-off ... -->
              <v-btn icon>
                <a>LG</a>
              </v-btn>
