<template>
  <div class="u3menu mx-auto">
    ...
    <!--  User AVATAR  -->
    <v-row id="u3r1" class="mx-auto" align="center" justify="center">
      <img class="uimg" :src="ico" />
    </v-row>

    <!--  User LOGOUT  -->
    <v-row id="u3r3" class="mx-auto" align="center" justify="center">
      <v-col></v-col>
    </v-row>
  </div>
</template>
