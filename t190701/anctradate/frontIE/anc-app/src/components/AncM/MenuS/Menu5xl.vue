<template>
  <div>
    ...
    >
      <v-row v-show="drawerLeft" class="m5r" text-align="center">
        <!-- /*xl*/ system... -->
        <v-col class="rmH5 m5cL" cols="4"></v-col>
        <!-- user -->
        <v-col class="rmH5 m5cC rcC_BC" cols="4">
          <u5xl></u5xl>
        </v-col>
        <!-- cats menu -->
        <v-col class="rmH5 m5cR" cols="4">
          <div :class="rcU">
            <m5xl></m5xl>
          </div>
        </v-col>
...
.m5cR {
  position: relative;
  z-index: 3;
  /*menu 5 - xl - Column Right - Menu Categorie */
